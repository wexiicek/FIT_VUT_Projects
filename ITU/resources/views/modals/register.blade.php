            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="register_username" class="col-md-4 col-form-label text-md-right control-label">Username</label>

                            <div class="col-md-6">
                                <input id="register_username" type="text" class="form-control @error('register_username') is-invalid @enderror" name="register_username" value="{{ old('register_username') }}" required autocomplete="register_username">
