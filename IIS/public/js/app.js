...
$(".seat_btn").click(function () {
  ...
  var instance_id = $("#instance_id").text();
  var token = $("meta[name=csrf-token]").attr("content");
  var time = new Date();
  var hours = time.getHours() < 10 ? "0" + time.getHours() : time.getHours();
  var minutes = time.getMinutes() < 10 ? "0" + time.getMinutes() : time.getMinutes();
  var timestamp = "".concat(time.getDate(), ".").concat(time.getMonth(), ".").concat(time.getFullYear(), " ").concat(hours, ":").concat(minutes);
  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      $("#price_total").text(parseFloat($("#price_per_ticket").text()) * parseInt($("#ticket_amount").val()));
    },
...
$(".ticket_c").click(function () {
  ...
  $.ajax({
    ...
    ContentType: "application/json;charset=UTF-8",
    success: function success(res) {
      that.parent().siblings(".ticket_paid").text("Paid");
...
$(".ticket_can").click(function () {
  var token = $("meta[name=csrf-token]").attr("content");
  var ticket_id = $(this).parent().siblings(".ticket_id").text();
  var that = $(this);
  $.ajax({
    ...
    ContentType: "application/json;charset=UTF-8",
    success: function success(res) {
      that.removeClass('ticket_can btn btn-primary').text("Canceled");
    },
    error: function error(res) {
      console.log(res.responseText);
    }
...
__webpack_require__(/*! C:\wamp64\www\iis_proj\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\iis_proj\resources\sass\app.scss */"./resources/sass/app.scss");
